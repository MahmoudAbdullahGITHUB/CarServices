...
import com.example.carserviceapp.Screens.DriverProfile;
...
public class DriverLoginFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        emailET = view.findViewById(R.id.duserName);
        passwordET = view.findViewById(R.id.dpassword);
        driverLoginBu = view.findViewById(R.id.dloginBu);

        driverLoginBu.setOnClickListener(new View.OnClickListener() {
            @Override
